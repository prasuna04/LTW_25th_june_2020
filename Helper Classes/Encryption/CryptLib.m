...
- (NSData *)generateRandomIV:(size_t)length
{
	 ...
	 */
/* Added By Prasuna for ios 13 issue on 22nd Jan 2020 - starts here */
...
/* Added By Prasuna for ios 13 issue on 22nd Jan 2020 - ends  here */


- (NSString*) sha256:(NSString *)key length:(NSInteger) length
{
   // const char *s=[key cStringUsingEncoding:NSASCIIStringEncoding];
   // const char *s=[key dataUsingEncoding:NSUTF8StringEncoding];
