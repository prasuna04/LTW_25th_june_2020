...
open class WSTagView: UIView {
    ...
    fileprivate func updateLabelText() {
        /* remove operation added By Prasuna - starts here */
        // Unselected shows "[displayText]," and selected is "[displayText]"
        textLabel.text = displayText + displayDelimiter + " X " // remove operation added By Prasuna
        /* remove operation added By Prasuna - ends here */
        // Expand Label
