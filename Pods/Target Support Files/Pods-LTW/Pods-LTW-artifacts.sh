...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/AppsFlyerFramework/Mac Catalyst/AppsFlyerLib.xcframework" "" "false" "ios-x86_64-maccatalyst/AppsFlyerLib.framework" "ios-i386_x86_64-simulator/AppsFlyerLib.framework" "ios-armv7_arm64/AppsFlyerLib.framework"
fi
