...
+ (NSString*) signString: (NSString*)str withKeyData:(const char*) cKey keyLength:(NSInteger) keyLength{
    ...
    CCHmac(kCCHmacAlgSHA256, cKey, keyLength, cData, [str length], cHMAC);
...
+ (NSString*) signString: (NSString*)str withKey:(NSString*) key{
    ...
    return [self signString:str withKeyData:cKey keyLength:[key length]];//strlen(cKey) // Added By Prasuna,  Everytime you update pod please add this line in this class also .
}
