...
public class CountryPickerView: NibView {
    ...
    /* Commented By Ranjeet Raushan on 1st April 2020 - starts here */
    /// Change the text color of phone code
//    public var textColor = UIColor.black {
//        didSet { setup() }
//    }
     /* Commented By Ranjeet Raushan on 1st April 2020  - ends here */
    ...
    func setup() {
        ...
        countryDetailsLabel.font = font
         ...
         /* Added By Ranjeet Raushan on 1st April 2020 - starts here */
        if #available(iOS 13.0, *) {
            countryDetailsLabel.textColor = UIColor.label
        } else {
            // Fallback on earlier versions
        }
         /* Added  By Ranjeet Raushan on 1st April 2020 - ends here  */
