...
extension MessageView {
    ...
    public func configureTheme(_ theme: Theme, iconStyle: IconStyle = .default) {
        ...
        case .success:
           // let backgroundColor = UIColor(red: 97.0/255.0, green: 161.0/255.0, blue: 23.0/255.0, alpha: 1.0) // Commented By Ranjeet
            let backgroundColor = UIColor(red: 45.0/255.0, green: 169.0/255.0, blue: 236.0/255.0, alpha: 1.0) // Added By Ranjeet
